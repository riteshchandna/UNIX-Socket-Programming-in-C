...
const char s2[2] = " ";
 ...
 char msg[15];
    ...
    printf("The Client 2 sends the request %s to the Server 1 with port number _____ and IP address ____.",msg);
    printf("\nThe Client2’s port number is _______ and the IP address is _______.");
   ...
   // msg[numbytes]='\0';
  //  printf("\n%s",token2);
    printf("\nThe Client2 received the value %s from the Server 1 with port number _____and IP address____.",token2);
